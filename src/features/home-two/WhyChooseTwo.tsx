                ...
                <ul className="why-choose-two__review-list">
                    <li>
                        <div className="why-choose-two__review-img">
                            <Image src={WhyChooseTwoReviewImg11} width={54} height={54} alt='review'/>
                        </div>
                    </li>
                    <li>
                        <div className="why-choose-two__review-img">
                            <Image src={WhyChooseTwoReviewImg12} width={54} height={54} alt='review'/>
                        </div>
                    </li>
                    <li>
                        <div className="why-choose-two__review-img">
                            <Image src={WhyChooseTwoReviewImg13} width={54} height={54} alt='review'/>
                        </div>
                    </li>
                    <li>
                        <div className="why-choose-two__review-img">
                            <Image src={WhyChooseTwoReviewImg14} width={54} height={54} alt='review'/>
                        </div>
                    </li>
                </ul>
