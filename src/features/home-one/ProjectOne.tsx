                                        ...
                                        <div className="project-one__single">
                                            <div className="project-one__img-box">
                                                <div className="project-one__img">
                                                    <Image src={project?.img} width={403} height={530} alt={project?.subTitle} />
                                                </div>
                                                <div className="project-one__content">
                                                    <div className="project-one__title-box">
                                                        <p className="project-one__sub-title">{project?.subTitle}</p>
                                                        <h3 className="project-one__title"><Link href={project?.linkUrl}>{project?.title}</Link></h3>
                                                    </div>
                                                    <div className="project-one__arrow">
                                                        <Link href="#" className="img-popup" onClick={() => { setIndex(idx); setOpenLightBox(true) }}><span className="icon-right-arrow"></span></Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
