                            ...
                            >
                                <div className="about-one__img-box">
                                    <div className="about-one__img">
                                        <Image src={AboutOneImg1} width={570} height={590} alt='about' />
                                    </div>
                                            ...
                                            <ul className="list-unstyled about-one__review-list">
                                                <li>
                                                    <div className="about-one__review-img">
                                                        <Image src={AboutOneReviewImg11} width={54} height={54} alt='about' />
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="about-one__review-img">
                                                        <Image src={AboutOneReviewImg12} width={54} height={54} alt='about' />
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="about-one__review-img">
                                                        <Image src={AboutOneReviewImg13} width={54} height={54} alt='about' />
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="about-one__review-img">
                                                        <Image src={AboutOneReviewImg14} width={54} height={54} alt='about' />
                                                    </div>
                                                </li>
                                            </ul>
                                    ...
                                    <div className="about-one__shape-1">
                                        <Image src={AboutOneShape1} width={98} height={110} alt='about' />
                                    </div>
                                    <div className="about-one__shape-2">
                                        <Image src={AboutOneShape2} width={131} height={115} alt='about' />
                                    </div>
                                </div>
                            </FadeInAdvanced>
                        </div>
                            ...
                            <div className="about-one__btn-and-author-box">
                                ...
                                <div className="about-one__author-box">
                                    <div className="about-one__author-details">
                                        <div className="about-one__author-img-box">
                                            <div className="about-one__author-img">
                                                <Image src={AboutOneAuthorImg1} width={72} height={72} alt='about' />
                                            </div>
                                        </div>
                                    ...
                                    <div className="about-one__author-sign">
                                        <Image src={AboutOneAuthorSign} width={86} height={70} alt='about' />
                                    </div>
                                </div>
                            </div>
                        </div>
