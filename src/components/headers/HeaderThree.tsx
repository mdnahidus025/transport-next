                    ...
                    <div className="container">
                        <div className="main-menu-three__wrapper-inner">
                            ...
                            <div className="main-menu-three__main-menu-box">
                                <Link href="#" className="mobile-nav__toggler" onClick={() => setIsMobileManu((pre: boolean) => !pre)}><i className="fa fa-bars"></i></Link>
                                <MainManuList />
                            </div>
                                    ...
                                    <div className="main-menu-three__search-cart-box">
                                        <div className="main-menu-three__search-cart-box">
                                            ...
                                            <div className="main-menu-three__cart-box">
                                                <Link href="/inner/cart" className="main-menu-three__cart">
